    ...
    <div className=' mt-10 text-center'>
      ...
      <div className=' text-2xl flex justify-center text-slate-700'>
        ...
        <div className=" text-slate-500">
            <p> Need 
            <Link href="/support"><strong><a className=" underline"> Support </a></strong></Link>
            regarding product contact<strong>( <a href="tel:9726698451" className=" underline">+91-9726698451</a>)</strong> </p>
        </div>
    </div>
  );
};
